...
steps = 0
da1, da2, da3, da4, da5 = args.da, "NA", "NA", "NA", "NA"
...
if __name__ == "__main__":
    ...
    for epoch in range(1, epochs+1):
        ...
        if epoch%25==0 or epoch==epochs or epoch==1:
            ...
            update_csv_ts1(data_name, 'No-Aug', detached_train_acc, detached_train_loss, detached_test_acc, detached_test_loss, epoch, da1, now)
